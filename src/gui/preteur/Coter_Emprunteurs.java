		...
		btnCoter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (index == -1) {
					...
					dispose();
					Attribuer_Cote attribuer_Cote = new Attribuer_Cote(connect, currentPreteur, listEmprunteur.get(index));
