...
public class Ajouter_Participant extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3675290188723465368L;
	 ...
	 * Create the frame.
	 */
	public Ajouter_Participant(Connection connect, Administrateur currentAdministrateur) {
		...
		lblConfirmPassword.setBounds(24, 266, 137, 14);
		contentPane.add(lblConfirmPassword);

		confirmPasswordField = new JPasswordField();
		confirmPasswordField.setBounds(233, 263, 162, 20);
